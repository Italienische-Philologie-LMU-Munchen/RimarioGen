...
$destinationDirectory = "$env:APPDATA\RimarioGen"
# Using https://devblogs.microsoft.com/powershell-community/determine-if-a-folder-exists/ 
Write-Host "Check if there is a previous installation of Rimario Generator..."
...
# Create shortcut to start Rimario Generator on desktop
...
Write-Host "Creating a shortcut to Rimario Generator on Desktop..."
$TargetFile = "$env:APPDATA\RimarioGen\rimarioGen.ps1"
$desktopPath = [Environment]::GetFolderPath("Desktop")
$shortcutFile = "$desktopPath\Rimario Generator.lnk"
$WScriptShell = New-Object -ComObject WScript.Shell
$shortcut = $WScriptShell.CreateShortcut($ShortcutFile)
$shortcut.TargetPath = "powershell.exe"
$shortcut.Arguments = "-NoExit -ExecutionPolicy Bypass -Command `"& '" + $TargetFile + "'`""
$shortcut.IconLocation = "$env:APPDATA\RimarioGen\assets\clipboard-list-solid.ico"
$shortcut.Save()
